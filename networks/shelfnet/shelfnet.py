# code from: https://github.com/juntang-zhuang/ShelfNet
import torch
...
class ShelfNet(nn.Module):
    def __init__(self, n_classes, criterion = None, *args, **kwargs):
        super(ShelfNet, self).__init__()

        if criterion is not None:
            self.criterion1 = criterion[0]
            self.criterion2 = criterion[1]
            self.criterion3 = criterion[2]
        else:
            self.criterion1 = self.criterion2 = self.criterion3 = None       
    ...
    def forward(self, x, labels = None,  aux = True):
        H, W = x.size()[2:]
        ...
        if aux:
            ...
            if self.criterion1 is not None and labels is not None:
                return self.criterion1(feat_out, labels)+self.criterion2(feat_out16, labels)+self.criterion2(feat_out32, labels)           
            else:
